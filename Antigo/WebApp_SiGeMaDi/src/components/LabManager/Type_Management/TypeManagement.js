...
import { sci_areaUrl, typeSci_Area_By_IdUrl } from '../../Links'
...
function Type_Management(props) {
    ...
    function deleteTypes(id) {
        ...
        axios.delete(typeSci_Area_By_IdUrl.replace(':sci_area_id', sci_area).replace(':id', id))
            .then(resp => {
                Response_Handler(resp)
                setTimeout(() => searchTypes(sci_area), 2000)
            })
            .catch(err => {
